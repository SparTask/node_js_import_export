...
var localReadStream = fs.createReadStream('package.json');
var file =bucket.file('lebdiri.arezki@gmail.com.csv');
        file.acl.add({
  entity: 'allUsers',
...
listContactUrl = "https://gcdc2013-iogrow.appspot.com/_ah/api/crmengine/v1/contacts/listv2?alt=json";
var access_token = "ya29.9AGL3Cy44RBp6ygRi8uRxmBRaejFedBc4B-16w8TmMTbaSP7m9_oenmCwrrG-1Bu33K-"
...
var out = [outlookhead];
var params = {order: "-updated_at", limit: 20}
...
function getItem(params, url, access_token, callback) {
    var item = {};
    request.post({
        url: url,// "https://gcdc2013-iogrow.appspot.com/_ah/api/crmengine/v1/contacts/getv2?alt=json",
        json: params
...
async.whilst(
    ...
    function (next) {
        ...
        request.post({url: listContactUrl, json: params}, function (error, response, body) {
            ...
            async.whilst(
                ...
                function (callback) {
                    ...
                    getItem(p, getContactUrl, access_token,
                        function (resp) {
                ...
                function (err) {
                    console.log("finsh get listing -----------------------------")
                    next();
                }
            );

            params = {order: "-updated_at", limit: 1000, pageToken: nextPageToken}
...
//https://storage.googleapis.com/gcdc2013-iogrow.appspot.com/aaasothere%40gmail.com_1442616304.41.csv
